...
<body class="bg-gray-100 p-4 md:p-12 font-serif">
    ...
    <form id="evaluationForm" method="POST" class="max-w-5xl mx-auto bg-white border border-gray-400 shadow-2xl">
        ...
        <table class="w-full border-collapse">
            ...
            <?php 
            $criteria = [1=>"Articulate requirements", 2=>"Choose appropriate tools and methods for each task", 3=>" Give clear and coherent oral presentation", 4=>"Functioned well as a team"];
